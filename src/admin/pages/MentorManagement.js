...
class MentorManagement extends Component {
  ...
  componentDidUpdate(prevProps) {
    console.log("Component updated:", this.props.users);
    if (
...
const mapStateToProps = (state) => {
  return {
    ...
    users: state.userReducer.mentors,
...
export default connect(mapStateToProps, mapDispatchToProps)(MentorManagement);
